...
-(void)configureAxes {
    ...
    axisSet.xAxis.minorTickAxisLabels = nil;
    axisSet.xAxis.majorTickLocations = nil;
    axisSet.xAxis.minorTickLocations = nil;
    ...
    axisSet.yAxis.minorTickAxisLabels = nil;
...
//    NSLog(@"plot id: %@ - fieldEnum: %d / %d - index: %d / %d!", plot.identifier, fieldEnum, CPTBarPlotFieldBarTip, index, [[[CPDStockPriceStore sharedInstance] datesInWeek] count]);
